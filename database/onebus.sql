...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Okt 2021 pada 07.36
...
INSERT INTO `destinations` (`id`, `nama`) VALUES
(1, 'Depok'),
(2, 'Bogor'),
(3, 'Bandung');
...
INSERT INTO `hometowns` (`id`, `nama`) VALUES
(1, 'Depok'),
(2, 'Bogor'),
(3, 'Bandung');
...
INSERT INTO `terminal_asal` (`id`, `nama`, `id_kota_asal`) VALUES
...
INSERT INTO `terminal_tujuan` (`id`, `nama`, `id_kota_tujuan`) VALUES
(1, 'Terminal Terpadu Depok', 1),
(2, 'Terminal Baranangsiang ', 2),
(3, 'Terminal Leuwi Panjang', 3);
...
--
ALTER TABLE `bus`
  ADD CONSTRAINT `bus_ibfk_1` FOREIGN KEY (`id_rute`) REFERENCES `hometown_destination` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `terminal_asal`
  ADD CONSTRAINT `terminal_asal_ibfk_1` FOREIGN KEY (`id_kota_asal`) REFERENCES `hometowns` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `terminal_tujuan`
--
ALTER TABLE `terminal_tujuan`
  ADD CONSTRAINT `terminal_tujuan_ibfk_1` FOREIGN KEY (`id_kota_tujuan`) REFERENCES `destinations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
